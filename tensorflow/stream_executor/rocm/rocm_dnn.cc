...
bool MIOpenSupport::GetMIOpenConvolveAlgorithmsFindMode(
  ...
  // std::unique_ptr<miopenConvAlgoPerf_t[]> returnedAlgorithms(
  //     new miopenConvAlgoPerf_t[requestedAlgorithmCount]);

  // size_t returnedAlgorithmCount = 1;
  ...
  //         &returnedAlgorithmCount, returnedAlgorithms.get(),
  //         scratch_memory_temp.opaque(), scratch_memory_size,
  //         exhaustiveSearch);
  //     if (status != miopenStatusSuccess) {
  ...
  //         &returnedAlgorithmCount, returnedAlgorithms.get(),
  //         scratch_memory.opaque(), scratch_memory_size, exhaustiveSearch);
  //     if (status != miopenStatusSuccess) {
