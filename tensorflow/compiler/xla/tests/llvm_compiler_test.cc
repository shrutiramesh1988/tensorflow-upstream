...
// Creating dummy data structure needed to initialize a GpuCompilerTest
...
// unit test only
class GpuCompilerTest : public GpuCompiler {
 public:
  GpuCompilerTest() : GpuCompiler(kDummyTestId, kDummyTriple, kDummyLayout) {}
